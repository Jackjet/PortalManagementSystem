<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AfterVideoEdit.aspx.cs" Inherits="PMSWeb.Admin.AfterVideoEdit" %>
            ...
            <div class="newcourse_dialog_detail">
                <div class="clearfix">
                            ...
                            <div class="shangchuan">
                                ...
                                <div class="shgnchuanbottoma fl ml20">
                                    <div class="ui-upload-holder">
                                        <div id="fileup" class="ui-upload-txt">
                                            点击上传
                                        </div>
                                        <input id="fileToUpload1" type="file" size="45" name="fileToUpload1" class="input ui-upload-input bluebutton dianjisc" style="margin-top: 0;" />
                                    </div>
                                </div>
                    ...
                    <div class="course_form_div clearfix">
                     ...
                     <div class="course_form_div clearfix">
                        <label for="">时间：</label>
                        <input type="text" class="Wdate text" id="StarDate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" 
style="height: 26px; border: 1px solid #9ec5e2; border-radius: 2px; width: 178px;" runat="server" />
                        <i class="stars"></i>
                    </div>
                    ...
                    <div class="course_form_select clearfix" style="text-align:center;">
                        ...
                        <a href="javascript:window.history.go(-1);" class="course_btn confirm_btn"  style="display:inline-block;">返回
</a>
                    </div>
                ...
                $.ajaxFileUpload(
                    {
                        ...
                        dataType: 'json',
                        data: { action: "UploadImgForAdvertContent" },
                        success: function (data, status) {
                            if (data.result) {
                                var imgpath = decodeURIComponent(data.imgpath);
                                var filepath = decodeURIComponent(data.filepath);
                                $("#HFilePath").val(filepath);
