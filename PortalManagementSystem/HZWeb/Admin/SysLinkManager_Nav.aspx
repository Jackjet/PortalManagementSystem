<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysLinkManager_Nav.aspx.cs" Inherits="PMSWeb.Admin.SysLinkManager_Nav" %>
<!DOCTYPE html>
    ...
    <style>
     ...
     <script id="tr_Link" type="text/x-jquery-tmpl">
        <tr>
            ...
            <td>
                <a href="javascript:;" onclick="javascript: window.location='SysLinkEdit_Nav.aspx?Id=${Id}'"><i class="icon icon-edit"></i>修改</a>
            ...
            <div class="course_manage bordshadrad">
                ...
                <div class="newcourse_select clearfix">
                    <div class="distributed fr">
                        <a href="javascript:void(0);" onclick="javascript: window.location='SysLinkEdit_Nav.aspx'"><i class="icon icon-plus"></i>添加</a>
                    </div>
                </div>
                <div class="wrap">
                    <table>
