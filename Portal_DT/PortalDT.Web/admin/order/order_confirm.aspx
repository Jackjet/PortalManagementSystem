<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_confirm.aspx.cs" Inherits="PortalDT.Web.admin.order.order_confirm" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new PortalDT.BLL.payment().GetTitle(Convert.ToInt32(Eval("payment_id")))%></td>
    <td><%#new PortalDT.BLL.express().GetTitle(Convert.ToInt32(Eval("express_id")))%></td>
