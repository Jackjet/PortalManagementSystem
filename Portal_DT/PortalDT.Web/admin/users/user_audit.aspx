<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_audit.aspx.cs" Inherits="PortalDT.Web.admin.users.user_audit" %>
...
<ItemTemplate>
  <tr>
    ...
    <td><%#new PortalDT.BLL.user_groups().GetTitle(Convert.ToInt32(Eval("group_id")))%></td>
