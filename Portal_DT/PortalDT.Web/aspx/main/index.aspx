<%@ Page Language="C#" AutoEventWireup="true" Inherits="PortalDT.Web.UI.Page.index" ValidateRequest="false" %>
<%@ Import namespace="System.Collections.Generic" %>
<%@ Import namespace="System.Text" %>
<%@ Import namespace="System.Data" %>
<%@ Import namespace="PortalDT.Common" %>
...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by DTcms Template Engine at 2017/5/17 13:41:56.
		本页面代码由DTcms模板引擎生成于 2017/5/17 13:41:56. 
	*/
	...
	templateBuilder.Append(linkurl("music"));

	templateBuilder.Append("\">音乐</a>\r\n          <a href=\"");
	...
	DataTable linkList1 = get_plugin_method("PortalDT.Web.Plugin.Link", "link", "get_link_list", 0, "is_lock=0 and is_image=0 and is_red=1");
	...
	templateBuilder.Append("\r\n    </div>\r\n    <ul class=\"img\">\r\n      ");
	DataTable linkList2 = get_plugin_method("PortalDT.Web.Plugin.Link", "link", "get_link_list", 10, "is_lock=0 and is_image=1 and is_red=1");
